...
<body>
  ...
  <main>
    <section class="content">
      ...
      <div class="row">
      <div class="container">
      <h5>Détails du livre n°${livre.getIdLivre()}</h5>
        <div class="row">
	      <form action="livre_details?id=${livre.getIdLivre()}" method="post" class="col s12"> <!-- TODO : remplacer idDuLivre par l'id du livre -->
	        <div class="row">
